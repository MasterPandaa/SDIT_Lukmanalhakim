        ...
        <div class="col-12">
            ...
            @if(!isset($indikatorKelulusan) || !$indikatorKelulusan)
                <div class="alert alert-warning alert-dismissible fade show mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>Peringatan!</strong> Data indikator kelulusan tidak dapat dimuat. Silakan coba lagi atau hubungi administrator.
                        </div>
                    </div>
                    <button type="button" class="close" data-dismiss="alert">
                        <span>&times;</span>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <ul class="nav nav-tabs card-header-tabs" id="indikatorKelulusanTabs" role="tablist">
                ...
                <div class="card-body">
                    <div class="tab-content" id="indikatorKelulusanTabContent">
                        <!-- Header Section -->
...
$(document).ready(function() {
    ...
    // Image preview for foto pembicara
    $('#foto_pembicara').on('change', function() {
        try {
            const file = this.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    $('#fotoPembicaraPreview').attr('src', e.target.result).show();
                }
                reader.readAsDataURL(file);
            }
        } catch (e) {
            console.error('Foto pembicara preview error:', e);
        }
    });
