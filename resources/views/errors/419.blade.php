        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="four-zero-content">
                    ...
                    <h2 class="title">Error 419!</h2>
                    <p>Oops! Sesi Anda Telah Kedaluwarsa</p>
            ...
            <div class="col-lg-8 col-sm-6 col-12">
                <div class="foue-zero-thumb">
                    <img src="{{ asset('assets/images/419.png') }}" alt="419">
                </div>
            </div>
        </div>
    </div>
</div>
<!-- 419 section ending here -->
@endsection 